...
LOGGER.info("Mizuhara is now Active | An Rental Association project. | Licensed under GPLv3.")

LOGGER.info("Project maintained by: github.com/minatouzuki (t.me/minatouzuki)")
