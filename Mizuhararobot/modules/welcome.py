        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Oh kami-san,command me.", reply_to_message_id=reply
                )
                welcome_log = (
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A member of the Rental Association just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "Huh! A Tsar disaster just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Huh! Someone with a Hussar disaster level just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_text(
                    "Oof! A Ronin disaster just joined!", reply_to_message_id=reply
                )
                continue
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_text(
                    "Oof! A Envoy disaster just joined!", reply_to_message_id=reply
                )
                continue
